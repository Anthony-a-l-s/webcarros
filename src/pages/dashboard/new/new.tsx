...
const schema = z.object({
    ...
    whatsapp: z.string().min(1, 'O preço é obrigatório').refine((value) => /^(\d{10,12})$/.test(value), {
    ...
    async function handleFile(e: ChangeEvent<HTMLInputElement>) {
        if (e.target.files && e.target.files[0]) {
            ...
            if (image.type === 'image/jpeg' || image.type === 'image/png') {
                ...
                alert("Envie uma igagen jpg ou png")
                return;
            }
        }
    }

    async function hadleUpload(image: File) {
        if (!user?.uid) {
            return;
        }
        ...
        const uploaadREf = ref(storage, `images/${currentUid}/${uidImage}`);
        uploadBytes(uploaadREf, image)
            .then((snapshot) => {
                ...
                >
                    ...
                    <div className="mb-3">
                        ...
                        <Input
                            ...
                            placeholder="Ex: 1.0 Premier Automático... "
                        />
                    </div>
                    ...
                    <div className="flex w-full mb-3 flex-row items-center gap-4">
                        ...
                        <div className="w-full">
                            ...
                            <Input
                                ...
                                placeholder="Ex: Juiz de fore - MG... "
                            />
                        </div>
                    </div>
